...
class HomeForSaleAdFilterSetLiteForm(BetterModelForm):
    class Meta:
        model = HomeForSaleAd
        # TOOD: fields below don't really work, must use fieldsets
        fields = ('location', )
        fieldsets = [('location', {'fields': ['location'], 'legend': 'Dessinez votre zone de recherche'}),]

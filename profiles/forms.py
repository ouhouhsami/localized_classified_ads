...
class UserProfileCustomForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(UserProfileCustomForm, self).__init__(*args, **kwargs)
...
class SignupFormExtra(SignupFormOnlyEmail):
    """
    Signup form using crispy-forms app, twitter-boostrap style
    and custom teaser text based on current site.
    """
    def __init__(self, *args, **kwargs):
        self.helper = FormHelper()
        self.helper.form_class = 'form-horizontal'
